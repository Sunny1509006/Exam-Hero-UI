    ...
    <div className="ssc-humanities">
      ...
      <div className="ssc-humanities-container">
        <div className="ssc-humanities-program-header">
          ...
          <div className="ssc-humanities-program-tagline">Study smart and excel in exams with Exam Hero!</div>
          <p className="ssc-humanities-program-intro">
        ...
        <div className="ssc-humanities-program-section">
          <h2>📚 Included Books & Subjects (Humanities + Common Books)</h2>
          
          <div className="ssc-humanities-subjects-grid">
            <div className="ssc-humanities-subject-category">
              <h3>🎓 Humanities Subjects</h3>
              <ul className="ssc-humanities-subject-list">
          ...
          <div className="ssc-humanities-program-note">
            <p>
        ...
        <div className="ssc-humanities-program-section">
          ...
          <div className="ssc-humanities-exam-features">
            <div className="ssc-humanities-exam-feature">
              <h4>📝 MCQ Tests</h4>
        ...
        <div className="ssc-humanities-program-section">
          ...
          <div className="ssc-humanities-features-grid">
            <div className="ssc-humanities-feature-item">
              <span className="ssc-humanities-feature-icon">📚</span>
        ...
        <div className="ssc-humanities-program-section ssc-humanities-perfect-for-section">
          <h2>🎯 Perfect For</h2>
          
          <div className="ssc-humanities-perfect-for-list">
            <div className="ssc-humanities-perfect-for-item">
              <span className="ssc-humanities-check-icon">✅</span>
        ...
        <div className="ssc-humanities-program-footer">
          <div className="ssc-humanities-conclusion">
            ...
            <div className="ssc-humanities-cta-buttons">
              <a href="#download" className="ssc-humanities-cta-button primary">Download App Now</a>
              <a href="#learn-more" className="ssc-humanities-cta-button secondary">Learn More</a>
            </div>
          </div>
        </div>
      </div>
